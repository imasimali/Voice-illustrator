...
const MyProfile = () => {
  ...
  return (
    ...
    <section className="myPage">
        ...
        <h2 className="n-ame">Mutahra Salman</h2>
        <p className="user">@mutahra11salman</p>
        <div className="edit">
            <Button className="editbtn" variant="light" onClick={handleShow}>Edit Profile</Button>
        ...
        <h5 className="change">Change profile picture</h5>
            ...
            <Form>
                <Form.Group className="mb-3 about" controlId="formBasicEmail">
                    ...
                    <Form.Control className="inputBx" type="text" placeholder="Write a short bio" />
